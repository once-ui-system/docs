...
docs: "magic-docs/components.mdx"
navLabel: "Components"
navIcon: "components"
---
...
Icons are used to visually represent actions, objects, or concepts. For instructions on importing new icons, head over to [the Once UI documentation](https://docs.once-ui.com/once-ui/contexts/iconProvider).
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://docs.once-ui.com/once-ui/components/icon" weight="default" label="Learn more" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
<CodeBlock
    ...
    preview={<Grid columns="2" m={{columns: 1}} gap="8"><PageList path={["magic-docs"]} /></Grid>}
    codes={[
      {
        code:
`<Grid columns="2" m={{columns: 1}} gap="8">
