...
Icons are used to visually represent actions, objects, or concepts.
...
<CodeBlock
    ...
    topRadius="l"
    codeHeight={24}
    codePreview={<SmartImage src="/images/docs/magic-bio.jpg" alt="Example image" sizes="640px" aspectRatio="16/9" radius="l" />}
    codeInstances={[
      {
        code:
`<SmartImage
...
<CodeBlock
    ...
    topRadius="l"
    codeHeight={24}
    codePreview={<SmartImage src="https://www.youtube.com/watch?v=M5lFtW1BvPc" alt="Example video" aspectRatio="16/9" radius="l" />}
    codeInstances={[
      {
        code:
`<SmartImage
...
<CodeBlock
    ...
    codePreview={<Grid columns="2" mobileColumns="1" gap="8"><PageList path={["magic-docs"]} /></Grid>}
    codeInstances={[
      {
        code:
