...
<CodeBlock
    ...
    topRadius="l"
    codeHeight={24}
    codePreview={<Media src="/images/docs/magic-bio.jpg" alt="Example image" sizes="640px" aspectRatio="16/9" radius="l" />}
    codeInstances={[
      {
        code:
`<Media
...
<CodeBlock
    ...
    topRadius="l"
    codeHeight={24}
    codePreview={<Media src="https://www.youtube.com/watch?v=M5lFtW1BvPc" alt="Example video" aspectRatio="16/9" radius="l" />}
    codeInstances={[
      {
        code:
`<Media
