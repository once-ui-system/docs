...
Static routes for home, changelog, and roadmap are pre-configured. When [disabling](/docs/magic-docs/pages#static-pages) `/changelog` or `/roadmap`, the corresponding routes are automatically removed from the search results in Kbar.
