...
docs: "magic-portfolio/content.mdx"
navLabel: "Content"
navIcon: "page"
---
...
const person = {
  ...
    ...
    language: "tsx",
    label: "src/resources/content.js"
  }
]} />
...
Social links are rendered on the `/about` page and in the footer based on the array configured in the `social` object. You can set custom icons to each, but don't forget to import them in `src/resources/icons.ts`. Read the Once UI documentation](https://docs.once-ui.com/once-ui/contexts/iconProvider) for more information.
