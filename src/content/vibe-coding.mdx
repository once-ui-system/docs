...
Agents can pull Once UI documentation through [Context7’s MCP server](https://context7.com/once-ui-system/docs), supported in editors like Windsurf and Cursor.
